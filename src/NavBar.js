...
// import badgeImg from "../src/img/badge.png";
// import penImg from "../src/img/pen.png";
// import searchImg from "../src/img/search.png";
  ...
  return (
    <nav>
      <ul style={navBarStyle}>
        <li>
          <Link to="/">
            <img src="../src/img/star.png" alt="star img" style={imgSt}></img>
          </Link>
        </li>
        <li>
