...
const server = http.createServer(function (req, res) {
    ...
    if (req.method === "POST"){
        ...
        // sendQuery(`INSERT INTO \`bookreview\`(\`userid\`,\`username\`,\`userpic\`,\`booktitle\`,\`bookcover\`,\`isbn\`,\`summery\`,\`body\`,\`tag\`) SELECT \`userinfo\`.\`user-id\`,\`userinfo\`.\`user-name\`,\`userinfo\`.\`user-pic\`,'${bookreview.booktitle}', '${bookreview.bookcover}','${bookreview.isbn}',${bookreview.summery}','${bookreview.body}','${bookreview.tag}' WHERE \`userinfo\`.\`user-id\`='${bookreview.userid}`)
